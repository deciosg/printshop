...
public class AdministratorController {
	...
	public String list(Model model) {
		model.addAttribute("titleHeader", "Administradores");
		model.addAttribute("employees", employeeRepository.findAllByRole(Role.ROLE_ADMIN));
	...
	public String createOrUpdate(@Valid Employee employee, BindingResult bindingResult, Model model) {
		...
		return "redirect:/administradores/" + employee.getId();
	}
